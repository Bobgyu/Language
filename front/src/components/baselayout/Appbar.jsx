...
const Appbar = () => {
  return (
    <div className="appbar-wrapper ml-[calc(20%+14px)] w-[calc(80%-28px)] py-3 px-6 bg-white dark:bg-gray-950 round-sm dark:shadow-[0_0_0.25rem_rgba(255,255,255,0.3)] shadow-[0_0_0.25rem_rgba(165,163,174,0.3)]">
            ...
            <form>
              <div className="input-group flex items-center bg-gray-300 dark:bg-gray-700 h-11 min-w-80 py-1 px-3 rounded-xl">
                ...
                <input
                  ...
                  className="border-none outline-0 text-[15px] bg-gray-300 dark:bg-gray-700 text-gray-950 dark:text-gray-white px-3 placeholder-gray-800 dark:placeholder-white"
                />
              </div>
            </form>
          </div>
